...
export const ExplorerCopilot = ({
  ...
  return (
    <article className="rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-panel)] p-6 shadow-[0_24px_80px_var(--color-shadow)]">
      ...
      <div className="mt-6 rounded-[1.5rem] border border-[var(--color-border)] bg-[var(--color-panel-soft)] p-4">
      ...
      <div className="mt-6 space-y-3">
        {missionBrief.prompts.map((prompt) => (
          <div key={prompt} className="rounded-[1.25rem] border border-[var(--color-border)] bg-[var(--color-panel-soft)] p-4">
