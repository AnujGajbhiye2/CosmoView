...
export const RoutePlaceholder = ({
  ...
  return (
    <section className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
      <div className="rounded-[1rem] border border-white/10 bg-white/6 p-8 shadow-[0_24px_80px_rgba(3,8,21,0.45)] backdrop-blur">
      ...
      <div className="grid gap-4">
        <div className="rounded-[1rem] border border-white/10 bg-[linear-gradient(160deg,rgba(14,26,55,0.9),rgba(7,11,21,0.92))] p-6">
        ...
        <div className="rounded-[1rem] border border-dashed border-white/12 bg-white/4 p-6">
