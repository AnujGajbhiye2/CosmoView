...
- Name: navigation.spec.ts >> Navigation >> clicking "Mission Control" nav link loads Mission Control page
- Location: e2e\navigation.spec.ts:18:5

# Error details

```
Error: Console errors on /: Access to XMLHttpRequest at 'https://cosmoview.onrender.com/api/v1/epic/natural/latest' from origin 'http://localhost:5173' has been blocked by CORS policy: The 'Access-Control-Allow-Origin' header has a value 'https://cosmo-view.vercel.app' that is not equal to the supplied origin.
  ...
  - generic [ref=e4]:
    - banner [ref=e5]:
      - generic [ref=e7]:
        ...
        - heading "Mission Control" [level=1] [ref=e9]
      - generic [ref=e10]:
        - button "Switch to dark mode" [ref=e12]:
          - generic [ref=e13]: Light
        - navigation [ref=e16]:
          - link "Mission Control" [active] [ref=e17] [cursor=pointer]:
            - /url: /
            - img [ref=e18]
    ...
    - main [ref=e49]:
      - generic [ref=e52]:
        ...
        - generic [ref=e71]:
          - img [ref=e72]
          - paragraph [ref=e78]: Loading transmission
        - heading "Synchronizing mission control" [level=3] [ref=e79]
        - paragraph [ref=e80]: Collecting APOD imagery, asteroid telemetry, Earth observation, and archive search results for the main dashboard.
        - paragraph [ref=e82]: Stabilizing feed
    - contentinfo [ref=e87]:
      - generic [ref=e88]:
        - paragraph [ref=e89]: CosmoView
        - paragraph [ref=e90]:
          - text: Powered by the
          - link "NASA Open APIs" [ref=e91] [cursor=pointer]:
            - /url: https://api.nasa.gov
      - paragraph [ref=e92]: © 2026 CosmoView — built for exploration
  - generic:
    - contentinfo:
      - button "Open TanStack Router Devtools" [ref=e93] [cursor=pointer]:
        - generic [ref=e94]:
          - img [ref=e96]
          - img [ref=e131]
        - generic [ref=e165]: "-"
        - generic [ref=e166]: TanStack Router
  - generic [ref=e167]:
    - img [ref=e169]
