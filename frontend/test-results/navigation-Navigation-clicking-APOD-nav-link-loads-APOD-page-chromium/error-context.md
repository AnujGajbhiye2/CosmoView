...
- Name: navigation.spec.ts >> Navigation >> clicking "APOD" nav link loads APOD page
- Location: e2e\navigation.spec.ts:18:5

# Error details

```
Error: Console errors on /apod: Access to XMLHttpRequest at 'https://cosmoview.onrender.com/api/v1/apod' from origin 'http://localhost:5173' has been blocked by CORS policy: The 'Access-Control-Allow-Origin' header has a value 'https://cosmo-view.vercel.app' that is not equal to the supplied origin.
    ...
    - banner [ref=e5]:
      ...
      - generic [ref=e10]:
        ...
        - navigation [ref=e16]:
          ...
          - link "APOD" [active] [ref=e23] [cursor=pointer]:
            - /url: /apod
            - img [ref=e24]
            - text: APOD
      ...
      - generic [ref=e50]:
        ...
        - generic [ref=e55]:
          ...
          - generic [ref=e57]:
            ...
            - 'button "Select APOD date: 2026-04-05" [ref=e60] [cursor=pointer]':
