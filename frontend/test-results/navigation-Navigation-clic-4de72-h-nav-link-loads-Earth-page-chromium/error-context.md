...
```
Error: Console errors on /earth: Access to XMLHttpRequest at 'https://cosmoview.onrender.com/api/v1/asteroids/feed?startDate=2026-04-05&endDate=2026-04-07' from origin 'http://localhost:5173' has been blocked by CORS policy: The 'Access-Control-Allow-Origin' header has a value 'https://cosmo-view.vercel.app' that is not equal to the supplied origin.
...
Failed to load resource: net::ERR_FAILED
Access to XMLHttpRequest at 'https://cosmoview.onrender.com/api/v1/epic/natural?date=2026-04-02' from origin 'http://localhost:5173' has been blocked by CORS policy: The 'Access-Control-Allow-Origin' header has a value 'https://cosmo-view.vercel.app' that is not equal to the supplied origin.
Failed to load resource: net::ERR_FAILED
