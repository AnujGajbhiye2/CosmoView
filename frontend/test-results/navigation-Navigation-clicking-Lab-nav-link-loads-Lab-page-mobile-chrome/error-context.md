...
- Name: navigation.spec.ts >> Navigation >> clicking "Lab" nav link loads Lab page
- Location: e2e\navigation.spec.ts:18:5

# Error details

```
Error: Console errors on /lab: Access to XMLHttpRequest at 'https://cosmoview.onrender.com/api/v1/epic/natural/latest' from origin 'http://localhost:5173' has been blocked by CORS policy: The 'Access-Control-Allow-Origin' header has a value 'https://cosmo-view.vercel.app' that is not equal to the supplied origin.
    ...
    - banner [ref=e5]:
      ...
      - navigation [ref=e16]:
        ...
        - link "Library" [ref=e43] [cursor=pointer]:
          ...
          - img [ref=e44]
          - text: Library
        - link "Lab" [active] [ref=e46] [cursor=pointer]:
          - /url: /lab
          - img [ref=e47]
          - text: Lab
    - main [ref=e49]:
      - generic [ref=e52]:
        ...
        - heading "Contacting mission control" [level=3] [ref=e79]
        - paragraph [ref=e80]: Fetching the latest NASA telemetry and preparing your next view.
