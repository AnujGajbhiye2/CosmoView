...
Expected: visible
Error: strict mode violation: getByRole('heading', { name: 'Orion Nebula', level: 4 }) resolved to 4 elements:
    1) <h4 class="mt-3 text-xl font-semibold tracking-[-0.03em] text-[var(--color-text-strong)]">Orion Nebula</h4> aka getByRole('button', { name: 'Orion Nebula 2017-12-08 Orion' }).first()
    2) <h4 class="mt-3 text-xl font-semibold tracking-[-0.03em] text-[var(--color-text-strong)]">Orion Nebula Wide Field</h4> aka getByRole('button', { name: 'Orion Nebula Wide Field 2017-' }).first()
    3) <h4 class="mt-3 text-xl font-semibold tracking-[-0.03em] text-[var(--color-text-strong)]">Orion Nebula</h4> aka getByRole('button', { name: 'Orion Nebula 2017-12-08 Orion' }).nth(1)
    4) <h4 class="mt-3 text-xl font-semibold tracking-[-0.03em] text-[var(--color-text-strong)]">Orion Nebula Wide Field</h4> aka getByRole('button', { name: 'Orion Nebula Wide Field 2017-' }).nth(1)
